...
component accessors="true" {
	...
	function getXmlConverter(){
		if ( isNull( variables.xmlConverter ) ) {
			variables.xmlConverter = new wirebox.system.core.conversion.XMLConverter();
		}
	...
	function getExtraInfoAsString(){
		...
		if (
			...
			return new wirebox.system.web.context.ExceptionBean( variables.extraInfo ).$toString();
		}
