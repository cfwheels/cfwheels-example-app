	...
	extends     ="wirebox.system.cache.AbstractCacheBoxProvider"
{
	 ...
	 *
	 * @return wirebox.system.cache.util.IStats
	 */
	function getStats(){
		return new "wirebox.system.cache.providers.cf-lib.CFStats"( getObjectStore().getStatistics() );
	}
	 ...
	 *
	 * @return wirebox.system.cache.store.IObjectStore or any depending on the cache implementation
	 */
