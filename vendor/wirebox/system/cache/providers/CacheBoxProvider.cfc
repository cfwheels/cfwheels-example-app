...
component
	accessors   ="true"
	serializable="false"
	implements  ="wirebox.system.cache.providers.ICacheProvider"
	extends     ="wirebox.system.cache.AbstractCacheBoxProvider"
{
	 ...
	 *
	 * @doc_generic wirebox.system.cache.policies.IEvictionPolicy
	 */
	 ...
	 *
	 * @doc_generic wirebox.system.cache.store.IObjectStore
	 */
	 ...
	 *
	 * @doc_generic wirebox.system.cache.util.CacheStats
	 */
	property name="stats";
	...
	function init(){
		...
		variables.elementCleaner = new wirebox.system.cache.util.ElementCleaner( this );
		// Runtime Java object
	...
	function configure(){
		...
		lock
			...
			// Prepare Statistics
			variables.stats          = new wirebox.system.cache.util.CacheStats( this );
	 ...
	 *
	 * @return wirebox.system.cache.store.IObjectStore
	 */
	 ...
	 *
	 * @return wirebox.system.cache.policies.IEvictionPolicy
	 */
